        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="/app/invoice/preview/" class="btn btn-sm btn-icon btn-text-secondary rounded-pill waves-effect" data-bs-toggle="tooltip" title="Preview"><i class="ri-eye-line ri-20px"></i></a>' +
